...
from aleph_scoring.scoring.models import CrnScore, CrnMeasurements, NodeScores

METRICS_EMITTER = "0x4d741d44348B21e97000A8C9f07Ee34110F7916F"


async def query_asn_info(conn: asyncpg.connection) -> Dict[str, Dict]:
...
async def compute_crn_scores() -> List[CrnScore]:
    ...
    asn_info: Dict[str, Dict] = await query_asn_info(conn)
    ...
    print("{} nodes with a total score greater than zero".format(
